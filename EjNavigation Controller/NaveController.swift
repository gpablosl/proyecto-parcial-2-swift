...
class NaveController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        naves.append(Nave(nombre: "Nave 1", designacion: "IFD-5", id: "32FWG6236A", nivel: "Nivel 1", armamento: "Laser", imagen: "Nave1-1", stats: []))
        ...
        naves.append(Nave(nombre: "Nave 2", designacion: "IFX-1", id: "23626AEFB", nivel: "Nivel 2", armamento: "Laser", imagen: "Nave2-1", stats: []))
        ...
        naves.append(Nave(nombre: "Nave 3", designacion: "YGR-53", id: "436373FHBD", nivel: "Nivel 2", armamento: "Cañones", imagen: "Nave3-1", stats: []))
        ...
        naves.append(Nave(nombre: "Nave 4", designacion: "F-68", id: "JFT5RESRE544", nivel: "Nivel 3", armamento: "Laser", imagen: "Nave4-1", stats: []))
        ...
        naves.append(Nave(nombre: "Nave 5", designacion: "B-90", id: "SDG3463GER3", nivel: "Nivel 3", armamento: "Misiles", imagen: "Nave5-1", stats: []))
        ...
        naves.append(Nave(nombre: "Nave 6", designacion: "JG-54", id: "NHJTGFTJ544", nivel: "Nivel 3", armamento: "Cañon riel", imagen: "Nave6-1", stats: []))
        ...
        naves.append(Nave(nombre: "Nave 7", designacion: "YS-32", id: "574454DHERD", nivel: "Nivel 4", armamento: "Mixto", imagen: "Nave7-1", stats: []))
        ...
        naves.append(Nave(nombre: "Nave 8", designacion: "FSX-2", id: "3525RHDHD34", nivel: "Nivel 4", armamento: "Nuclear", imagen: "Nave8-1", stats: []))
